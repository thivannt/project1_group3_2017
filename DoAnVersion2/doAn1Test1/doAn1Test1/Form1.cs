...
namespace doAn1Test1
{
    public partial class Form1 : Form
    {
        ...
        void Distribute(ref int nb, ref int nc, int k)
        {
            ...
            while (pa < soPhanTu)
            {
                for (i = 0; (pa < soPhanTu) && (i < k); i++, pa++, pb++)
                {
                    b[pb] = a[pa];
                    MangB[pb] = mangNhap[pa];
                    Button_di_len(MangB[pb], 2 * kichThuoc);
                    Den_tdo_x_button(MangB[pb], pb);
                    //Tam_dung();
                ...
                for (i = 0; (pa < soPhanTu) && (i < k); i++, pa++, pc++)
                {
                    ...
                    button_di_xuong(MangC[pc], kichThuoc + 80);
                    Den_tdo_x_button(MangC[pc], pc);
                    //Tam_dung();
        ...
        void Merge_tang(int nb, int nc, int k)
        {
            ...
            while ((nb > 0) && (nc > 0))
            {
                ...
                if (b[pb + ib] <= c[pc + ic])
                {
                    ...
                    this.Invoke((MethodInvoker)delegate
                    {
                        Den_vtri_button(MangB[pb + ib], pa);
                    });
                    ...
                    if (ib == kb)
                    {
                        for (; ic < kc; ic++)
                        {
                            ...
                            this.Invoke((MethodInvoker)delegate
                            {
                                Den_vtri_button(MangC[pc + ic], pa);
                            });
            ...
            for (; nb > 0; nb--)
            {
                ...
                this.Invoke((MethodInvoker)delegate
                {
                    Den_vtri_button(MangB[lennb - nb], pa);
                });
            ...
            for (; nc > 0; nc--)
            {
                ...
                this.Invoke((MethodInvoker)delegate
                {
                    Den_vtri_button(MangC[lennc - nc], pa);
                });
        ...
        // quickSort
        void QuickSort_tang(int left, int right)
        {
            int i, j, x;
            x = a[(left + right) / 2];
            i = left; j = right;
            ...
            if (left < j)
            {
                QuickSort_tang(left, j);
            }
            if (i < right)
            {
                QuickSort_tang(i, right);
            }
